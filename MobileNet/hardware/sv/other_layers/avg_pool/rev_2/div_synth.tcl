...
# Global assignments 
set_global_assignment -name TOP_LEVEL_ENTITY "|avg_pool"
...
set_global_assignment -section_id avg_pool -name EDA_DESIGN_ENTRY_SYNTHESIS_TOOL "SYNPLIFY"
...
set_global_assignment -name SDC_FILE "div_synth.scf"
