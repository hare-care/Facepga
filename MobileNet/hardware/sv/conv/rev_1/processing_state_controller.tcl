...
# Global assignments 
set_global_assignment -name TOP_LEVEL_ENTITY "|resizer"
set_global_assignment -name ROUTING_BACK_ANNOTATION_MODE NORMAL
set_global_assignment -name FAMILY "CYCLONE V"
set_global_assignment -name DEVICE "5CGXFC7C6F23C6"
set_global_assignment -section_id resizer -name EDA_DESIGN_ENTRY_SYNTHESIS_TOOL "SYNPLIFY"
...
set_global_assignment -name SDC_FILE "processing_state_controller.scf"
