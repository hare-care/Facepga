...
# Global assignments 
set_global_assignment -name TOP_LEVEL_ENTITY "|convolutional_layer"
set_global_assignment -name ROUTING_BACK_ANNOTATION_MODE NORMAL
set_global_assignment -name FAMILY "CYCLONE V"
set_global_assignment -name DEVICE "5CGXFC7C6F23C6"
set_global_assignment -section_id convolutional_layer -name EDA_DESIGN_ENTRY_SYNTHESIS_TOOL "SYNPLIFY"
...
set_global_assignment -name SDC_FILE "convolutional_layer.scf"
...
# Incremental Compilation
    ...
    # incremental compilation will be enabled
     set Design_Name "convolutional_layer" 
